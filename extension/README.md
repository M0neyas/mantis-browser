...
| `settings/` | **Nastavení Mantis** (`options_ui`; z nové karty nebo about:addons): obraz v obraze při přepnutí karty, automatické přehrávání, plynulé rolování, WebGL (Zabezpečení), kill switch VPN, hodiny/pozadí nové karty, zapomenout web, choulostivé stránky, šifrované DNS, co jde přes VPN, synchronizace, aktualizace |
